...
function MackieC4(context) {
  ...
  this.midiInput.mOnSysex = function(context, message) {
    ...
    if (self.isVersionReply(message)) {
      ...
      console.log("- Version: ".concat(arrayToAscii(self.version)));
    }
  ...
  // Spot Erase
  var ledSpotErase   = this.surface.makeLamp(7.2, 55, 1.5, 1.5).setShapeCircle();
  ...
  // Function
  var led_func  = this.surface.makeLamp(1.72, 5.5, 0.15, 0.15).setShapeCircle();
  this.func      = new Button(this.surface, this.midiInput, this.midiOutput, 16.2, 56.5, 3.5, 3.5, 0x08);
...
var EqSubPageArea = eqMixPage.makeSubPageArea('EQ area');
...
for (var i = 0; i < 8; ++i) {
  ...
  // EQ 1
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mPushValue,    channelBankItem[i].mChannelEQ.mBand1.mOn).setSubPage(subPageEQ1).setTypeToggle();
  eqMixPage.makeValueBinding(knobRow0[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mFreq).setSubPage(subPageEQ1);
  eqMixPage.makeValueBinding(knobRow1[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mGain).setSubPage(subPageEQ1);
  eqMixPage.makeValueBinding(knobRow2[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mQ).setSubPage(subPageEQ1);
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mFilterType).setSubPage(subPageEQ1);
  // EQ 2[i]
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mPushValue,    channelBankItem[i].mChannelEQ.mBand2.mOn).setSubPage(subPageEQ2).setTypeToggle();
  eqMixPage.makeValueBinding(knobRow0[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mFreq).setSubPage(subPageEQ2);
  eqMixPage.makeValueBinding(knobRow1[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mGain).setSubPage(subPageEQ2);
  eqMixPage.makeValueBinding(knobRow2[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mQ).setSubPage(subPageEQ2);
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mFilterType).setSubPage(subPageEQ2);
  // EQ 3
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mPushValue,    channelBankItem[i].mChannelEQ.mBand3.mOn).setSubPage(subPageEQ3).setTypeToggle();
  eqMixPage.makeValueBinding(knobRow0[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mFreq).setSubPage(subPageEQ3);
  eqMixPage.makeValueBinding(knobRow1[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mGain).setSubPage(subPageEQ3);
  eqMixPage.makeValueBinding(knobRow2[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mQ).setSubPage(subPageEQ3);
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mFilterType).setSubPage(subPageEQ3);
  // EQ 4
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mPushValue,    channelBankItem[i].mChannelEQ.mBand4.mOn).setSubPage(subPageEQ4).setTypeToggle();
  eqMixPage.makeValueBinding(knobRow0[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mFreq).setSubPage(subPageEQ4);
  eqMixPage.makeValueBinding(knobRow1[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mGain).setSubPage(subPageEQ4);
  eqMixPage.makeValueBinding(knobRow2[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mQ).setSubPage(subPageEQ4);
  eqMixPage.makeValueBinding(knobRow3[i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mFilterType).setSubPage(subPageEQ4);
...
function sendFeedbackOut(context, button, ch) {
  ...
  // Get Track Name
  if (button.row == 0) {
    var textDisplayValue = mackieC4.surface.makeCustomValueVariable('textDisplayValue')
    textDisplayValue.mOnTitleChange = function(context, objectTitle, valueTitle) {
      var text = "      |";
    ...
    eqMixPage.makeValueBinding(textDisplayValue, ch)
  }
  ...
  button.pushEncoder.mEncoderValue.mOnProcessValueChange = function (context, newValue) {
    ...
    //console.log("ProcessValueChange(".concat(r, ",", c, ") = ", newValue.toString()))
    switch (button.row) {
      case 0:
        break;
      case 1:
...
subPageEQ1.mOnActivate = function(activeDevice) {
  ...
  for (var i = 0; i < 8; i++) {
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[0][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mFreq).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[1][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mGain).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[2][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mQ).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[3][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand1.mFilterType).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
//
    // Frequency
...
subPageEQ2.mOnActivate = function(activeDevice) {
  ...
  for (var i = 0; i < 8; i++) {
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[0][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mFreq).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[1][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mGain).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[2][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mQ).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[3][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand2.mFilterType).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
...
subPageEQ3.mOnActivate = function(activeDevice) {
  ...
  for (var i = 0; i < 8; i++) {
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[0][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mFreq).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[1][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mGain).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[2][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mQ).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[3][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand3.mFilterType).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
...
subPageEQ4.mOnActivate = function(activeDevice) {
  ...
  for (var i = 0; i < 8; i++) {
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[0][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mFreq).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[1][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mGain).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[2][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mQ).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
    //eqMixPage.makeValueBinding(mackieC4.pushEncoder[3][i].pushEncoder.mEncoderValue, channelBankItem[i].mChannelEQ.mBand4.mFilterType).mOnValueChange = function(activeDevice, activeMapping, value, diffValue) {}
...
// Instead of this:
// eqMixPage.makeActionBinding(prevBank.button.mSurfaceValue,  hostMixerBankZone.mAction.mPrevBank);
// eqMixPage.makeActionBinding(nextBank.button.mSurfaceValue,  hostMixerBankZone.mAction.mNextBank);
...
eqMixPage.makeActionBinding(prevBankSelect, hostMixerBankZone.mAction.mPrevBank)
eqMixPage.makeActionBinding(nextBankSelect, hostMixerBankZone.mAction.mNextBank)
